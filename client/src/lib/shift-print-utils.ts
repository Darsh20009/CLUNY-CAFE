...
export function buildShiftPrintFragment(p: any, bizName = 'CLUNY CAFE'): string {
...
export function buildMergedPrintFragment(periods: any[], dateLabel: string, bizName = 'CLUNY CAFE'): string {
