...
//
// ╔═══════════════════════════════════════════════════════════════════════════════════════════╗
// ║  CLUNY CAFE MASTER FRONTEND CONFIGURATION                                                     ║
...
export const STACK = {
  ...
  payments:  "Geidea (card + Apple Pay), Cash, CLUNY CAFE Loyalty Card",
  port:      5000,
...
export const FILE_MAP = {
  ...
  // ── Assets ───────────────────────────────────────────────────────────────────
  "Logo (customer)":          "attached_assets/cluny-logo-customer.png",
  "Logo (staff/manager)":     "attached_assets/cluny-logo-staff.png",
