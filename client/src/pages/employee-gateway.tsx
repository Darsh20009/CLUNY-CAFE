...
export default function EmployeeGateway() {
  ...
  useEffect(() => {
    document.title = tc("بوابة الموظفين - CLUNY CAFE | نظام الإدارة", "Staff Gateway - CLUNY CAFE | Management System");
    const metaDesc = document.querySelector('meta[name="description"]');
    if (metaDesc) metaDesc.setAttribute('content', tc("بوابة دخول الموظفين لنظام إدارة CLUNY CAFE", "Staff login gateway for CLUNY CAFE management system"));
  }, []);
