              ...
              <Card>
                ...
                <CardContent>
                  <div className="space-y-3">
                    ...
                    <div className="flex justify-between items-center">
                      <span className="text-sm flex items-center gap-2"><Wallet className="w-4 h-4 text-purple-600" /> {tc("بطاقة كلوني", "CLUNY Card")}</span>
                        ...
                        <PieChart>
                          <Pie
                            data={[
                              ...
                              { name: tc('بطاقة كلوني', 'CLUNY Card'), value: summary.loyaltySales },
                            ].filter(d => d.value > 0)}
                  ...
                  <div className="h-64">
                    <ResponsiveContainer width="100%" height="100%">
                      <BarChart data={branches}>
                        ...
                        <Bar dataKey="loyaltySales" stackId="a" fill="#a855f7" name={tc("بطاقة كلوني", "CLUNY Card")} />
                      </BarChart>
                    </ResponsiveContainer>
                  </div>
                </CardContent>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="mt-6 p-4 bg-muted/50 rounded-lg">
                  ...
                  <div className="text-xs text-muted-foreground space-y-1">
                    ...
                    <p>• <strong>1103</strong> — {tc("بطاقة كلوني (مدين)", "CLUNY Card (Debit)")}</p>
