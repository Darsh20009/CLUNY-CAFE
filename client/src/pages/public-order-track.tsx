    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4" dir={isAr ? 'rtl' : 'ltr'}>
        <div className="text-center space-y-4">
          <img src={clunyLogo} alt="CLUNY CAFE" className="h-16 mx-auto object-contain" />
    ...
    <div className="min-h-screen bg-gray-50" dir={isAr ? 'rtl' : 'ltr'}>
      ...
      <div className="bg-black text-white py-5 px-4">
        <div className="max-w-lg mx-auto flex flex-col items-center gap-2">
          <img src={clunyLogo} alt="CLUNY CAFE" className="h-14 object-contain" />
          <h1 className="text-base font-bold tracking-widest text-white/90 uppercase">CLUNY CAFE</h1>
          ...
          <>
            ...
            <div className="bg-gradient-to-br from-gray-900 to-black rounded-2xl p-5 text-white">
              <div className="flex items-center gap-3 mb-4">
                <img src={clunyLogo} alt="CLUNY" className="h-10 object-contain flex-shrink-0" />
                <div>
            ...
            <p className="text-center text-xs text-gray-400 pb-4">
              {t('tracking.footer_quote')} — CLUNY CAFE
            </p>
          </>
        )}
