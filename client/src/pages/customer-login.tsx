...
export default function CustomerLogin() {
  ...
  useEffect(() => {
    document.title = tc("CLUNY CAFE — ادخل الآن", "CLUNY CAFE — Enter Now");
    const metaDesc = document.querySelector('meta[name="description"]');
    if (metaDesc) metaDesc.setAttribute('content', tc('تسجيل دخول عملاء CLUNY CAFE — سجّل أو اطلب بسرعة', 'CLUNY CAFE customer login — sign up or order quickly'));
  }, [tc]);
      ...
      <div className="min-h-screen bg-gradient-to-b from-background via-primary/5 to-background flex flex-col items-center justify-center p-4">
        <div className="text-center mb-8">
          <div className="flex flex-col items-center gap-2 mb-2">
            <img src={clunyLogo} alt="CLUNY CAFE" className="h-16 object-contain" />
            <h1 className="text-3xl font-bold font-playfair text-foreground">CLUNY CAFE</h1>
          </div>
