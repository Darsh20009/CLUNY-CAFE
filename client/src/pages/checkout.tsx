          ...
          <div className="lg:col-span-2 space-y-6">
            <Card>
              <CardContent className="pt-6 space-y-4">
                ...
                {/* Apple Pay direct button — hidden until Geidea activates Apple Pay on merchant account */}
                {/* To re-enable: set applePayEnabled=true in business config AND ensure Geidea has linked the certificate */}
                ...
                {/* Apple Pay inside card section — hidden until Geidea activates Apple Pay on merchant account */}
