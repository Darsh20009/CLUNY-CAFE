...
export default function EmployeeDashboard() {
  ...
  // Set SEO metadata
  useEffect(() => {
    document.title = "Employee Dashboard - CLUNY SYSTEMS | Order Management";
    const metaDesc = document.querySelector('meta[name="description"]');
    if (metaDesc) metaDesc.setAttribute('content', 'CLUNY SYSTEMS Employee Dashboard - Track orders, leave requests and notifications');
  }, []);
