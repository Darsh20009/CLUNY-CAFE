...
const SLIDES: Slide[] = [
  {
    id: "welcome",
    titleAr: "مرحباً بك في نظام CLUNY CAFE",
    titleEn: "Welcome to CLUNY SYSTEMS",
  ...
  },
  {
    ...
    render: (tc) => (
      <div className="grid md:grid-cols-2 gap-4">
        ...
        <Feature tc={tc} icon={<CreditCard className="w-5 h-5" />} titleAr="3 طرق دفع" titleEn="3 payment methods" descAr="نقدي / شبكة (مدى/فيزا/Apple Pay) / بطاقة CLUNY CAFE الذكية للولاء." descEn="Cash / Card (mada/Visa/Apple Pay) / CLUNY CAFE smart loyalty card." />
