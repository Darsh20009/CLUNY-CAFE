...
import blackRoseLogo from "@assets/cluny-logo-customer.png";
        ...
        <div className="bg-[#111111] border border-[#1e1e1e] rounded-2xl p-8 shadow-2xl">
          <div className="text-center mb-8">
            <div className="w-20 h-20 mx-auto mb-4">
              <img src={blackRoseLogo} alt="CLUNY CAFE" className="w-full h-full object-contain rounded-2xl" />
            </div>
            <h1 className="text-2xl font-bold text-white tracking-tight">CLUNY CAFE</h1>
          ...
          <div className="mt-6 pt-6 border-t border-[#1e1e1e] text-center">
            <p className="text-[#444] text-xs">
              CLUNY SYSTEMS v3.0 — Restricted Access
            </p>
          </div>
        </div>
      </div>
