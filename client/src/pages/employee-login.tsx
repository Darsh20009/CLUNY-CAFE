...
export default function EmployeeLogin() {
  ...
  useEffect(() => {
    document.title = tc("تسجيل دخول الموظفين - CLUNY SYSTEMS", "Employee Login - CLUNY SYSTEMS");
    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-4 sm:mb-6">
          ...
          <h1 className="text-xl sm:text-2xl font-bold text-foreground mb-1 font-playfair">CLUNY SYSTEMS</h1>
