      ...
      <div className="max-w-3xl mx-auto px-4 py-10">
        ...
        <div className="space-y-8">
          <div className="text-center border-b pb-8">
            ...
            <p className="text-muted-foreground text-sm">Privacy Policy — CLUNY CAFE</p>
          ...
          <div className="space-y-6 text-sm leading-relaxed">
            <section>
              ...
              <p>
                مرحباً بك في تطبيق CLUNY CAFE. نحن نحترم خصوصيتك ونلتزم بحماية بياناتك الشخصية.
          ...
          <div className="border-t pt-8" dir="ltr">
            ...
            <div className="space-y-4 text-sm leading-relaxed text-muted-foreground">
              <p>
                <strong className="text-foreground">1. Introduction.</strong> CLUNY CAFE ("we", "us") respects your privacy.
              ...
              <p>
                <strong className="text-foreground">8. Contact.</strong> CLUNY CAFE ·{" "}
          ...
          <div className="text-center text-xs text-muted-foreground border-t pt-6">
            © 2026 CLUNY CAFE — جميع الحقوق محفوظة
          </div>
        </div>
      </div>
    </div>
