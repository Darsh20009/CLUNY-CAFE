...
export default function ResetPassword() {
  ...
  useEffect(() => {
    document.title = tc("إعادة تعيين كلمة المرور - CLUNY CAFE", "Reset Password - CLUNY CAFE");
    const metaDesc = document.querySelector('meta[name="description"]');
    if (metaDesc) metaDesc.setAttribute('content', tc('إعادة تعيين كلمة المرور على CLUNY CAFE - أدخل كلمة مرور جديدة آمنة', 'Reset your CLUNY CAFE password - enter a new secure password'));
  }, [tc]);
        ...
        <CardHeader className="space-y-3 text-center pb-6">
          <div className="flex justify-center mb-1">
            {resetSuccess ? (
              ...
              <img src={clunyLogoStaff} alt="CLUNY" className="h-12 object-contain" />
            )}
          </div>
