        ...
        <CardContent className="space-y-4">
          ...
          <div className="flex flex-col gap-2">
            <div>
              ...
              <p className="text-xs text-muted-foreground mt-0.5">{tc("الرابط الذي يستخدمه العملاء (مثل https://cluny.cafe). إذا تركته فارغاً، سيستخدم نفس عنوان المتصفح.", "Public URL customers use (e.g. https://cluny.cafe). If empty, uses the current browser URL.")}</p>
            </div>
            <Input
              type="url"
