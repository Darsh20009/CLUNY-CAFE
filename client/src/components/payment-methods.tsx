              ...
              <div className="flex items-center gap-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-xs text-muted-foreground mt-0.5">
                    {tc("الدفع بالبطاقة سيكون متاحاً قريباً", "Card payment coming soon")}
                  </p>
                </div>
              </div>
            </CardContent>
                              ...
                              <Button 
                                ...
                                onClick={(e) => {
                                  ...
                                  toast({
                                    ...
                                    description: tc("سيتم خصم قيمة الطلب من رصيد بطاقة كلوني الخاصة بك", "The order value will be deducted from your card balance"),
                                  });
                                }}
                              >
                                <Zap className="w-4 h-4 ml-2" />
                                {tc("ادفع ببطاقة كلوني (كوبي)", "Pay with بطاقة كلوني (Copy)")}
                              </Button>
                               {foundCard && (
                              <Button 
                                size="sm"
