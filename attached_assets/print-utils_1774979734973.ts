...
<body>
  ...
  <div class="customer-copy">
    <div class="header">
      ...
      <div style="font-size: 14px; font-weight: bold; margin-top: 4px;">رقم الطلب: #${data.orderNumber.replace(/^ORD#|^ORD-/i, '')}</div>
  ...
  <div class="kitchen-copy">
    <div class="header">
      ...
      <div style="font-size: 28px; font-weight: bold; margin: 8px 0;">#${data.orderNumber.replace(/^ORD#|^ORD-/i, '')}</div>
...
export async function printTaxInvoice(data: TaxInvoiceData): Promise<void> {
  ...
  const displayInvoiceNumber = data.invoiceNumber || `#${data.orderNumber.replace(/^ORD#|^ORD-/i, '')}`;
  const { date: formattedDate, time: formattedTime } = formatDate(data.date);
  ...
  <div class="receipt">
    <div class="header">
      ...
      <div class="order-badge">
        <div class="order-number">#${data.orderNumber.replace(/^ORD#|^ORD-/i, '')}</div>
      </div>
...
<body>
  <div class="receipt">
    ...
    <div class="order-num-block">
      ...
      <div class="order-num-value">#${data.orderNumber.replace(/^ORD#|^ORD-/i, '')}</div>
    </div>
